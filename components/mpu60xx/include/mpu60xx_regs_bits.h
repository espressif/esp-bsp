...
#define MPU60xx_FF_THR              0x1D    // Free Fall detection threshold bits [7:0]
#define MPU60xx_FF_DUR              0x1E    // Duration counter, threshold for Free Fall int. 1 kHz rate, LSB = 1 ms
...
#define MPU60xx_ZMOT_THR            0x21    // Zero Motion detection threshold bits [7:0]
#define MPU60xx_ZMOT_DUR            0x22    // Duration counter, threshold for Zero motion detection int. 1 kHz rate, LSB = 1 ms
