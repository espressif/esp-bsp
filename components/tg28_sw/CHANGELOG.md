...
* Restore the original REGA2 model-source selection in `tg28_sw_read_battery_model` instead of forcing SRAM, so a POR-default (ROM) gauge does not end up running from an unprogrammed model
