 ...
 * @details USB HID demo (keyboard and mouse visualization using LVGL) for M5Stack Tab5 Board
 */
...
#if CONFIG_EXAMPLE_USB_STACK_CHERRYUSB
#include "usbh_core.h"
#endif
...
#elif CONFIG_EXAMPLE_USB_STACK_IDF
    bsp_usb_host_start(BSP_USB_HOST_POWER_MODE_USB_DEV, true);
#else
#error USB stack is not selected!
#endif
