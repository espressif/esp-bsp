...
TEST_CASE("LV Fill functionality ARGB8888", "[fill][functionality][ARGB8888]")
{
...
#if (CONFIG_IDF_TARGET_ESP32S3)
    test_matrix.min_w = 8;  // 8 is the lower limit for the esp32s3 asm implementation, otherwise esp32 is executed
#endif
    ...
    ESP_LOGI(TAG_LV_FILL_FUNC, "test matrices dims: %dx%d to %dx%d", test_matrix.min_w, test_matrix.min_h, test_matrix.max_w, test_matrix.max_h);
...
TEST_CASE("LV Fill functionality RGB565", "[fill][functionality][RGB565]")
{
    test_matrix_lv_fill_params_t test_matrix = default_test_matrix_lv_fill;
#if (CONFIG_IDF_TARGET_ESP32S3)
    test_matrix.min_w = 16;  // 16 is the lower limit for the esp32s3 asm implementation, otherwise esp32 is executed
#endif
...
TEST_CASE("LV Fill functionality RGB888", "[fill][functionality][RGB888]")
{
    test_matrix_lv_fill_params_t test_matrix = default_test_matrix_lv_fill;
#if (CONFIG_IDF_TARGET_ESP32S3)
    test_matrix.min_w = 12;  // 12 is the lower limit for the esp32s3 asm implementation, otherwise esp32 is executed
#endif
