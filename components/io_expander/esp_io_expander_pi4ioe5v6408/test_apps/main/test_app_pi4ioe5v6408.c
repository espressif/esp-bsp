...
#define I2C_MASTER_SDA_IO   31          /*!< gpio number for I2C master data  */
#define I2C_MASTER_NUM      I2C_NUM_0   /*!< I2C port number for master dev */
#define I2C_ADDRESS         ESP_IO_EXPANDER_I2C_PI4IOE5V6408_ADDRESS_LOW
...
static const char *TAG = "pi4ioe5v6408 test";
...
static void i2c_dev_pi4ioe5v6408_init(void)
{
    esp_err_t ret = esp_io_expander_new_i2c_pi4ioe5v6408(i2c_handle, I2C_ADDRESS, &io_expander);
    TEST_ASSERT_EQUAL_MESSAGE(ESP_OK, ret, "PI4IOE5V6408 create returned error");
}

static void i2c_dev_pi4ioe5v6408_deinit(void)
{
    esp_err_t ret = esp_io_expander_del(io_expander);
    TEST_ASSERT_EQUAL_MESSAGE(ESP_OK, ret, "PI4IOE5V6408 delete returned error");
}

TEST_CASE("IO expander pi4ioe5v6408 test", "[pi4ioe5v6408]")
{
    i2c_bus_init();
    i2c_dev_pi4ioe5v6408_init();
