...
#define I2C_ADDRESS         ESP_IO_EXPANDER_I2C_AW9523_ADDRESS_00
/*!< I2C address of slave dev */

#define TEST_LOOP_CNT       10
#define TEST_LOOP_DELAY_MS  500
#define TEST_OUTPUT_PINS    (IO_EXPANDER_PIN_NUM_0 | IO_EXPANDER_PIN_NUM_9)
#define TEST_INPUT_PINS     (IO_EXPANDER_PIN_NUM_14 | IO_EXPANDER_PIN_NUM_15)

static const char *TAG = "AW9523 test";
...
static void i2c_dev_aw9523_init(void)
{
    esp_err_t ret = esp_io_expander_new_i2c_aw9523(i2c_handle, I2C_ADDRESS, &io_expander);
    TEST_ASSERT_EQUAL_MESSAGE(ESP_OK, ret, "AW9523 create returned error");
}

static void i2c_dev_aw9523_deinit(void)
{
    esp_err_t ret = esp_io_expander_del(io_expander);
    TEST_ASSERT_EQUAL_MESSAGE(ESP_OK, ret, "AW9523 delete returned error");
}

TEST_CASE("IO expander AW9523 test", "[AW9523]")
{
    i2c_bus_init();
    i2c_dev_aw9523_init();
