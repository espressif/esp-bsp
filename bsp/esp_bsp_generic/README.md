...
|[espressif/esp_lcd_touch_cst816s](https://components.espressif.com/components/espressif/esp_lcd_touch_cst816s)|    ^1    |
...
<!-- Autogenerated start: Capabilities -->
### Capabilities
...
|SDCARD         |        :x:       |
|IMU            |        :x:       |
<!-- Autogenerated end: Capabilities -->
