...
| :1234: [CAPABILITIES](#1234-capabilities) | :floppy_disk: [SD CARD AND SPIFFS](#floppy_disk-sd-card-and-spiffs) | :musical_note: [AUDIO](#musical_note-audio) | :pager: [DISPLAY AND TOUCH](#pager-display-and-touch) | :radio_button: [BUTTONS](#radio_button-buttons) | :bulb: [LEDS](#bulb-leds) | :video_game: [SENSORS](#video_game-sensors) | 
| :-------------------------: | :-------------------------: | :-------------------------: | :-------------------------: | :-------------------------: | :-------------------------: | :-------------------------: | 
...
| Type | Name |
| ---: | :--- |
| define  | [**BSP\_BOARD\_ESP\_SENSAIRSHUTTLE**](#define-bsp_board_esp_sensairshuttle)  <br> |
...
| define  | [**BSP\_I2C\_SCL**](#define-bsp_i2c_scl)  (GPIO\_NUM\_3)<br> |
...
| define  | [**BSP\_I2S\_DOUT**](#define-bsp_i2s_dout)  (GPIO\_NUM\_7)<br> |
...
| define  | [**BSP\_SPEAKER\_EN**](#define-bsp_speaker_en)  (GPIO\_NUM\_1)<br> |
...
| define  | [**BSP\_LCD\_COLOR\_FORMAT**](#define-bsp_lcd_color_format)  (ESP\_LCD\_COLOR\_FORMAT\_RGB888)<br> |
| define  | [**BSP\_LCD\_COLOR\_SPACE**](#define-bsp_lcd_color_space)  (LCD\_RGB\_ELEMENT\_ORDER\_RGB)<br> |
| define  | [**BSP\_LCD\_CS**](#define-bsp_lcd_cs)  (GPIO\_NUM\_25)<br> |
| define  | [**BSP\_LCD\_DATA0**](#define-bsp_lcd_data0)  (GPIO\_NUM\_23)<br> |
| define  | [**BSP\_LCD\_DC**](#define-bsp_lcd_dc)  (GPIO\_NUM\_26)<br> |
| define  | [**BSP\_LCD\_EN**](#define-bsp_lcd_en)  (GPIO\_NUM\_5)<br> |
| define  | [**BSP\_LCD\_H\_RES**](#define-bsp_lcd_h_res)  (240)<br> |
| define  | [**BSP\_LCD\_PCLK**](#define-bsp_lcd_pclk)  (GPIO\_NUM\_24)<br> |
| define  | [**BSP\_LCD\_PIXEL\_CLOCK\_HZ**](#define-bsp_lcd_pixel_clock_hz)  (17 \* 1000 \* 1000)<br> |
...
| define  | [**BSP\_LCD\_V\_RES**](#define-bsp_lcd_v_res)  (284)<br> |
...
| Type | Name |
| ---: | :--- |
| define  | [**BSP\_BUTTON\_BOOT\_IO**](#define-bsp_button_boot_io)  (GPIO\_NUM\_9)<br> |
...
| Type | Name |
| ---: | :--- |
| define  | [**BSP\_LED\_RGB\_IO**](#define-bsp_led_rgb_io)  (GPIO\_NUM\_27)<br> |
