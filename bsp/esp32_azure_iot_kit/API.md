...
- [bsp/esp32_azure_iot_kit/include/bsp/display.h](#file-bspesp32_azure_iot_kitincludebspdisplayh)
- [bsp/esp32_azure_iot_kit/include/bsp/esp32_azure_iot_kit.h](#file-bspesp32_azure_iot_kitincludebspesp32_azure_iot_kith)

## File bsp/esp32_azure_iot_kit/include/bsp/display.h
...
```c
#define BSP_LCD_COLOR_FORMAT (ESP_LCD_COLOR_FORMAT_MONOCHROME)
```
...
### define `ESP_LCD_COLOR_FORMAT_MONOCHROME`

```c
#define ESP_LCD_COLOR_FORMAT_MONOCHROME (3)
```
...
## File bsp/esp32_azure_iot_kit/include/bsp/esp32_azure_iot_kit.h

_ESP BSP: ESP32-Azure IoT Kit._

**Deprecated**

This board is deprecated and no longer maintained
...
### define `BSP_CAPS_SENSOR_HUMIDITY`

```c
#define BSP_CAPS_SENSOR_HUMIDITY 1
```

### define `BSP_CAPS_SENSOR_LIGHT`

```c
#define BSP_CAPS_SENSOR_LIGHT 1
```

### define `BSP_CAPS_SENSOR_MAG`

```c
#define BSP_CAPS_SENSOR_MAG 1
```

### define `BSP_CAPS_SENSOR_PRESSURE`

```c
#define BSP_CAPS_SENSOR_PRESSURE 1
```

### define `BSP_CAPS_SENSOR_TEMPERATURE`
