...
#error The color format must be RGB888 in HDMI display type!
    ...
    ESP_GOTO_ON_ERROR(esp_lcd_panel_init(ctrl_panel), err, TAG, "LCD panel init failed"); ESP_LOGI(TAG, "Install MIPI DSI LCD data panel");
