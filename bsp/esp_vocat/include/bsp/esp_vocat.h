...
#define BSP_I2S_LCLK         (GPIO_NUM_39)
#define BSP_I2S_DOUT         (GPIO_NUM_41)
#define BSP_I2S_DSIN         (GPIO_NUM_3)
#define BSP_POWER_AMP_IO     (GPIO_NUM_15)
#define BSP_SPEAKER_EN       (GPIO_NUM_48)
#define BSP_MIC_EN           (GPIO_NUM_48)
/** @} */ // end of audio
 ...
 *  @{
 */
#define BSP_LED_1_IO         (GPIO_NUM_43)
/** @} */ // end of led
