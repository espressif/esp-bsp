...
| :1234: [CAPABILITIES](#1234-capabilities) | :floppy_disk: [SD CARD AND SPIFFS](#floppy_disk-sd-card-and-spiffs) | :musical_note: [AUDIO](#musical_note-audio) | :pager: [DISPLAY AND TOUCH](#pager-display-and-touch) | :electric_plug: [USB](#electric_plug-usb) | :video_game: [SENSORS](#video_game-sensors) | :camera: [CAMERA](#camera-camera) | 
| :-------------------------: | :-------------------------: | :-------------------------: | :-------------------------: | :-------------------------: | :-------------------------: | :-------------------------: | 
...
| Type | Name |
| ---: | :--- |
| struct | [**bsp\_spi\_cfg\_t**](#struct-bsp_spi_cfg_t) <br>_BSP display (LVGL) configuration structure._ |

## Functions

| Type | Name |
| ---: | :--- |
|  esp\_err\_t | [**bsp\_spi\_deinit**](#function-bsp_spi_deinit) (void) <br>_Deinit SPI driver and free its resources._ |
|  esp\_err\_t | [**bsp\_spi\_init**](#function-bsp_spi_init) (const [**bsp\_spi\_cfg\_t**](#struct-bsp_spi_cfg_t) \*config) <br>_Init SPI driver._ |



## Structures and Types Documentation

### struct `bsp_spi_cfg_t`

_BSP display (LVGL) configuration structure._

Variables:

-  uint32\_t max_transfer_sz  <br>Maximum SPI transfer size


## Functions Documentation

### function `bsp_spi_deinit`

_Deinit SPI driver and free its resources._
```c
esp_err_t bsp_spi_deinit (
    void
) 
```
...
_Init SPI driver._
```c
esp_err_t bsp_spi_init (
    const bsp_spi_cfg_t *config
) 
```
...
* ESP\_OK On success
* ESP\_ERR\_INVALID\_ARG Parameter error
* ESP\_FAIL Driver installation error
...
| define  | [**BSP\_SD\_EN**](#define-bsp_sd_en)  (IO\_EXPANDER\_PIN\_NUM\_4)<br> |
...
| define  | [**BSP\_MIC\_EN**](#define-bsp_mic_en)  (IO\_EXPANDER\_PIN\_NUM\_2)<br> |
| define  | [**BSP\_POWER\_AMP\_IO**](#define-bsp_power_amp_io)  (GPIO\_NUM\_NC)<br> |
| define  | [**BSP\_SPEAKER\_EN**](#define-bsp_speaker_en)  (IO\_EXPANDER\_PIN\_NUM\_2)<br> |
...
| define  | [**BSP\_LCD\_DATA0**](#define-bsp_lcd_data0)  (GPIO\_NUM\_37)<br> |
| define  | [**BSP\_LCD\_DC**](#define-bsp_lcd_dc)  (GPIO\_NUM\_35)<br> |
| define  | [**BSP\_LCD\_EN**](#define-bsp_lcd_en)  (IO\_EXPANDER\_PIN\_NUM\_9)<br> |
...
| define  | [**BSP\_TOUCH\_EN**](#define-bsp_touch_en)  (IO\_EXPANDER\_PIN\_NUM\_0)<br> |
...
| Type | Name |
| ---: | :--- |
| define  | [**BSP\_USB\_EN**](#define-bsp_usb_en)  (IO\_EXPANDER\_PIN\_NUM\_5)<br> |
...
| define  | [**BSP\_CAMERA\_EN**](#define-bsp_camera_en)  (IO\_EXPANDER\_PIN\_NUM\_8)<br> |
...
| Type | Name |
| ---: | :--- |
| define  | [**BSP\_IO\_EXPANDER\_ADDRESS**](#define-bsp_io_expander_address)  (ESP\_IO\_EXPANDER\_I2C\_AW9523\_ADDRESS\_00)<br> |
