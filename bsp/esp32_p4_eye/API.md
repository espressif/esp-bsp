...
| Type | Name |
| ---: | :--- |
| define  | [**BSP\_BOARD\_ESP32\_P4\_EYE**](#define-bsp_board_esp32_p4_eye)  <br> |
...
| Type | Name |
| ---: | :--- |
| define  | [**BSP\_ADC\_UNIT**](#define-bsp_adc_unit)  ADC\_UNIT\_2<br> |
...
| define  | [**BSP\_I2C\_SCL**](#define-bsp_i2c_scl)  (GPIO\_NUM\_13)<br> |
| define  | [**BSP\_I2C\_SDA**](#define-bsp_i2c_sda)  (GPIO\_NUM\_14)<br> |
...
| define  | [**BSP\_SD\_DET**](#define-bsp_sd_det)  (GPIO\_NUM\_45)<br> |
| define  | [**BSP\_SD\_EN**](#define-bsp_sd_en)  (GPIO\_NUM\_46)<br> |
...
| Type | Name |
| ---: | :--- |
| define  | [**BSP\_I2S\_CLK**](#define-bsp_i2s_clk)  (GPIO\_NUM\_22)<br> |
| define  | [**BSP\_I2S\_DOUT**](#define-bsp_i2s_dout)  (GPIO\_NUM\_NC)<br> |
| define  | [**BSP\_I2S\_DSIN**](#define-bsp_i2s_dsin)  (GPIO\_NUM\_21)<br> |
...
| Type | Name |
| ---: | :--- |
| define  | [**BSP\_LCD\_BACKLIGHT**](#define-bsp_lcd_backlight)  (GPIO\_NUM\_20)<br> |
...
| define  | [**BSP\_LCD\_CS**](#define-bsp_lcd_cs)  (GPIO\_NUM\_18)<br> |
| define  | [**BSP\_LCD\_DATA0**](#define-bsp_lcd_data0)  (GPIO\_NUM\_16)<br> |
| define  | [**BSP\_LCD\_DC**](#define-bsp_lcd_dc)  (GPIO\_NUM\_19)<br> |
| define  | [**BSP\_LCD\_EN**](#define-bsp_lcd_en)  (GPIO\_NUM\_12)<br> |
...
| Type | Name |
| ---: | :--- |
| define  | [**BSP\_BUTTON\_1\_IO**](#define-bsp_button_1_io)  (GPIO\_NUM\_35)<br> |
...
|  esp\_err\_t | [**bsp\_led\_set\_temperature**](#function-bsp_led_set_temperature) (led\_indicator\_handle\_t handle, const uint16\_t temperature) <br>_Set LED temperature._ |

## Macros

| Type | Name |
| ---: | :--- |
| define  | [**BSP\_LED\_1\_IO**](#define-bsp_led_1_io)  (GPIO\_NUM\_23)<br> |
...
* ESP\_OK Success
* ESP\_ERR\_INVALID\_ARG Parameter error
### function `bsp_led_set_temperature`

_Set LED temperature._
```c
esp_err_t bsp_led_set_temperature (
    led_indicator_handle_t handle,
...
* `handle` led handle 
* `temperature` Color temperature of LED 
...
| Type | Name |
| ---: | :--- |
| define  | [**BSP\_BATTERY\_VOLTAGE\_CHANNEL**](#define-bsp_battery_voltage_channel)  (ADC\_CHANNEL\_2)<br> |
